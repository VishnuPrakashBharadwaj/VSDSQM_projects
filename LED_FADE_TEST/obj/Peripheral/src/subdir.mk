...
Peripheral/src/%.o: ../Peripheral/src/%.c
	@	@	riscv-none-embed-gcc -march=rv32ecxw -mabi=ilp32e -msmall-data-limit=0 -msave-restore -Os -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -fno-common -Wunused -Wuninitialized  -g -I"D:\VSD\Projects\LED_FADE_TEST\Debug" -I"D:\VSD\Projects\LED_FADE_TEST\Core" -I"D:\VSD\Projects\LED_FADE_TEST\User" -I"D:\VSD\Projects\LED_FADE_TEST\Peripheral\inc" -std=gnu99 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
	@	@
